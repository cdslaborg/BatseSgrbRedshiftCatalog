...
if paraPostReadRequested
    for imodel = 1:Model.count
        ...
        Model.(Model.ID{imodel}).dataDir = ['D:\Dropbox\Projects\20181213_BatseSgrbRedshift\git\___zestimation___\bin\'];
        ...
        Model.(Model.ID{imodel}).stdLogLiso       = 10.0.^Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.logStdLogLiso ;
        Model.(Model.ID{imodel}).stdLogEpkz       = 10.0.^Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.logStdLogEpkz ;
        Model.(Model.ID{imodel}).stdLogEiso       = 10.0.^Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.logStdLogEiso ;
        Model.(Model.ID{imodel}).stdLogT90z       = 10.0.^Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.logStdLogT90z ;
        ...
        % convert all BATSE threshold parameters to log10 scale
        Model.(Model.ID{imodel}).avgLogThresh     = Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.avgLogThresh;
        Model.(Model.ID{imodel}).stdLogThresh     = 10.0.^Model.(Model.ID{imodel}).ParaDRAM.Output.Chain.Verbose.logStdLogThresh;
